...
- ❌ Apostrophes non échappées (L'harmonie → L\\'harmonie)
- ❌ Dict-style dans arrays ("clé": {...})
...
RETOURNEZ UNIQUEMENT CE JSON EXACT (copier-coller la structure):
{{
  ...
  "analyse_colorimetrique_detaillee": {{
    ...
    "description_teint": "Teint harmonieux",
    "description_yeux": "Yeux en harmonie",
    "description_cheveux": "Cheveux harmonieux",
    "harmonie_globale": "Ensemble coherent",
    "bloc_emotionnel": "Profil harmonieux",
    "impact_visuel": {{
      "effet_couleurs_chaudes": "Illumine le teint",
      "effet_couleurs_froides": "Ternit le teint",
      "pourquoi": "Sous-ton chaud"
    }}
  }}
}}
...
- Chaque objet dans array est: {{"key": value}}
- JAMAIS de virgule après le dernier élément d'un array/objet
"""