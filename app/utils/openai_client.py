...
class OpenAIClient:
    ...
    async def analyze_image(self, image_urls: list, prompt: str, model: str = "gpt-4o-mini", max_tokens: int = 3500):
    ...
    async def call_chat(self, prompt: str, model: str = "gpt-4o-mini"):
