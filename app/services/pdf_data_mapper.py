...
class PDFDataMapper:
    ...
    def prepare_liquid_variables(report_data: dict, user_data: dict) -> dict:
        ...
        # ✅ Page 8: Synthèse morphologie
        morphology_page1 = PDFDataMapper._transform_morphology_service_data(
            morphology_raw, 
            user_data
        )
        
        # ✅ Pages 9-15: 7 catégories vestimentaires
        morpho_categories = PDFDataMapper._generate_morphology_categories(
            morphology_raw, 
            user_data
        )
        ...
        # ✅ Logs morphologie
        print(f"   ✓ Page 8 (Morphologie): {morphology_page1.get('bodyType', 'Unknown')}")
        print(f"   ✓ Pages 9-15 (7 catégories): {len(morpho_categories)} catégories")
        if morpho_categories.get('hauts', {}).get('recommandes'):
            print(f"     • Hauts: {len(morpho_categories['hauts']['recommandes'])} recommandations")
    ...
    def _transform_morphology_service_data(morphology_raw: dict, user_data: dict) -> dict:
        """
        Transforme la réponse de morphology_service.analyze() 
        en structure attendue par le template Page 8 (morphology_page1)
        """
        
        silhouette_type = morphology_raw.get("silhouette_type", "")
        silhouette_explanation = morphology_raw.get("silhouette_explanation", "")
        body_analysis = PDFDataMapper._safe_dict(morphology_raw.get("body_analysis", {}))
        ...
        # Extraire les recommandations pour hauts
        ...
        # Construire les listes "à valoriser"
        highlights = []
        ...
        # Construire les listes "à harmoniser"
        minimizes = []
    ...
    def _generate_morphology_categories(morphology_raw: dict, user_data: dict) -> dict:
        """
        Génère les données pour Pages 9-15 (7 catégories vestimentaires)
        """
        ...
        robes = {
            ...
            "a_eviter": [
                ...
                {"name": "Ceintures trop larges non intégrées", "why": "Peuvent écaser plutôt que définir"},
            ...
            "motifs": {
                ...
                "a_eviter": "Rayures horizontales, gros motifs centré au buste, pois volumineux, carreaux qui élargissent"
            },
        ...
        vestes = {
            ...
            "a_eviter": [
                ...
                {"name": "Ceintures très larges", "why": "Peuvent écaser plutôt que définir"},
        ...
        return {
            ...
            "robes": robes,
            "vestes": vestes,
            "maillot_lingerie": maillot_lingerie,
